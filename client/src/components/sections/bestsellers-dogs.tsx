...
export default function BestsellersDogs() {
  ...
  return (
    <section className="relative bg-gradient-to-br from-amber-50 via-white to-yellow-50 rounded-3xl p-6 md:p-8 shadow-lg border border-amber-100">
      {/* Decorative elements */}
      <div className="absolute top-0 right-0 w-48 h-48 bg-amber-200/20 rounded-full blur-3xl"></div>
      ...
      <div className="relative z-10">
        <div className="mb-6 md:mb-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
            <div className="inline-flex items-center gap-3">
              <div className="p-2 bg-gradient-to-br from-amber-600 to-orange-600 rounded-xl shadow-lg">
                <Dog className="text-white w-6 h-6 md:w-7 md:h-7" />
              </div>
              <h2 className="text-2xl md:text-4xl font-bold bg-gradient-to-r from-amber-600 to-orange-600 bg-clip-text text-transparent">
            ...
            <a 
              ...
              className="inline-flex items-center gap-2 bg-white hover:bg-amber-50 text-amber-700 hover:text-orange-700 font-semibold px-5 py-2.5 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 text-sm md:text-base border border-amber-200 w-fit"
              rel="prefetch"
            >
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12 bg-white rounded-2xl border-2 border-dashed border-gray-300">
            ...
            <p className="text-gray-600 text-lg">No bestselling dog products available at the moment.</p>
          </div>
        ) : (
