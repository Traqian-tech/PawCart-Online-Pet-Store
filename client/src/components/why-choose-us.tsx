...
export default function WhyChooseUs() {
  const features = [
    ...
    },
    {
      icon: Truck,
      title: "Fast Delivery",
      description: "Quick delivery across Hong Kong to get your pet's essentials on time"
    },
    {
      icon: Shield,
    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h3 className="text-3xl font-bold text-gray-800 mb-4">Why Choose PawCart?</h3>
