      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-3 mb-4">
              <img
                src="/logo.png"
                alt="PawCart Pet Shop Logo"
                className="h-10 w-auto"
              />
              <h4 className="text-xl font-bold">PawCart Pet Shop</h4>
            </div>
            <p className="text-gray-300 mb-4">
              Your trusted partner for premium pet care products in Hong Kong. Making pets happy since 2020.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">852-6214-6811</span>
              </div>
              <div className="flex items-center space-x-3">
                <Mail className="w-5 h-5 text-primary-yellow" />
                <span className="text-gray-300">boqianjlu@gmail.com</span>
              </div>
              <div className="flex items-center space-x-3">
                <MapPin className="w-5 h-5 text-primary-yellow" />
                <span className="text-gray-300">Hung Hom, Kowloon, Hong Kong</span>
              </div>
              <div className="flex items-center space-x-3">
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-300">
            © 2025 PawCart Pet Shop. All rights reserved. | Made with ❤️ for pet lovers
          </p>
        </div>
      </div>
    </footer>
