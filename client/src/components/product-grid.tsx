          ...
          {products.map((product) => (
            ...
            >
              <CardContent className="p-3">
                ...
                <h4 className="font-medium mb-2 text-xs text-gray-800 line-clamp-2">{translateProductName(product.name, language)}</h4>
                {product.rating && (
                ...
                <div className="space-y-1">
                  <div className="flex items-center space-x-2">
                    <span className="text-sm font-bold text-purple-600">{format(product.price)}</span>
