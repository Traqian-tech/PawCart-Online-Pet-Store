...
// Priority: Environment variable > Replit detection > Current origin
function getPasswordResetUrl(): string {
  // Priority 1: Check for custom URL from environment variable
  // This allows easy configuration via .env or Replit Secrets
  // Set VITE_PASSWORD_RESET_URL in your environment variables
  ...
  // Priority 2: For production domains, use the current origin
  if (!currentOrigin.includes('localhost') && !currentOrigin.includes('127.0.0.1')) {
    return `${currentOrigin}/reset-password`;
  }

  // Priority 3: For development, try to detect Replit environment
  ...
  // Priority 4: Fallback - use current origin (will work when deployed to your domain)
  return `${currentOrigin}/reset-password`;
}
