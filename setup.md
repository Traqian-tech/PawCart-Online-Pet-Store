...
- `VITE_PASSWORD_RESET_URL` = `https://your-repl-name.replit.dev/reset-password` (Optional, for custom password reset URL)
...
### 3.5. Configure Password Reset (Important!)
1. Go to **Authentication** > **URL Configuration** in Supabase Dashboard
2. Add your redirect URLs:
   - For local development: `http://localhost:5000/reset-password`
   - For production: `https://yourdomain.com/reset-password`
   - For Replit: `https://your-repl-name.replit.dev/reset-password`
3. Click **Save**

**Note:** Without configuring redirect URLs, password reset links will not work!
See `SUPABASE_PASSWORD_RESET_QUICK_SETUP.md` for detailed instructions.
...
- Make sure you've added redirect URLs in Supabase Dashboard (Authentication > URL Configuration)
- Check that `VITE_PASSWORD_RESET_URL` matches your actual domain (if set)
- See `SUPABASE_PASSWORD_RESET_QUICK_SETUP.md` for troubleshooting
